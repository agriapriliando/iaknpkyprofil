<div class="container-fluid mt-3 dayak-bg" style="color: black">
    <div class="container p-5">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12 wow animate__animated animate__flipInY">
            ...
            <div class="col-lg-4 col-md-4 col-12 text-center wow animate__animated animate__flipInY">
                <h4>IKUTI KAMI</h4>
