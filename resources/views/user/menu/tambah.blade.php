...
<main>
    <div class="container-fluid">
        <h1 class="mt-4">Tambah Menu Navigasi</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Menu - Tambah</li>
        </ol>
        <!-- row two -->
        <div class="card mb-4">
            <div class="card-header">
                <i class="fas fa-table mr-1"></i>
                Form Tambah Menu Navigasi
            </div>
            <div class="card-body">
                <form action="{{url('admin/menu/simpan')}}" method="POST">
                    @method('PUT')
                    @csrf
                      <div class="mb-3">
